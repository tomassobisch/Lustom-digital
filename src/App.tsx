...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full z-[100] transition-all duration-700 ${scrolled ? 'py-4 nav-blur border-b border-black/5 shadow-sm' : 'py-10 bg-transparent'}`}>
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-16">
          {['Servicios', 'Estrategia', 'Contacto'].map((item) => (
            <a key={item} href={`#${item.toLowerCase()}`} className="text-[11px] font-black text-text-primary/50 hover:text-text-primary transition-all uppercase tracking-[0.4em] relative group">
              {item}
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-text-primary text-white px-10 py-5 rounded-full font-black text-[11px] uppercase tracking-[0.2em] transition-all shadow-xl shadow-black/5"
          >
            Impulsa tu Marca
          </motion.button>
        </div>
...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-40 pb-20 overflow-hidden bg-bg-primary soft-glow">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div style={{ y: y1, opacity }} className="relative mb-16">
...
const FeatureCard = ({ icon: Icon, title, desc, delay }: any) => (
  <motion.div 
    ...
    viewport={{ once: true }}
    className="group bg-white p-14 rounded-[50px] border border-black/5 hover:border-accent/50 transition-all duration-700 shadow-sm hover:shadow-2xl hover:shadow-black/[0.02]"
  >
    <div className="mb-12 inline-flex w-20 h-20 bg-bg-primary rounded-3xl items-center justify-center text-text-primary group-hover:bg-accent group-hover:text-white transition-all duration-500">
...
const Strategy = () => (
  <section id="estrategia" className="py-48 bg-bg-primary">
    <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-32 items-center">
      ...
      <div className="space-y-20">
        <div className="space-y-8">
          <h2 className="text-6xl font-black text-text-primary uppercase tracking-tighter leading-none">El Motor <br /><span className="text-accent-dark italic font-light">Lustom</span></h2>
  ...
  <section id="contacto" className="py-48 relative bg-white overflow-hidden">
    <div className="max-w-5xl mx-auto px-6 relative z-10">
      <div className="text-center mb-24">
        ...
        <p className="text-accent-dark font-black uppercase tracking-[0.6em] text-[11px]">Agencia Digital de Élite</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-20 mb-24">
        <div className="space-y-8">
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
               <span className="text-text-primary font-black text-3xl tracking-tighter uppercase leading-none italic">Lustom<span className="text-accent-dark italic font-light">Digital</span></span>
               <span className="text-[10px] text-accent-dark font-black uppercase tracking-[0.6em] mt-1">Digital Agency</span>
            </div>
          </div>
          <p className="text-text-primary/40 font-bold uppercase tracking-[0.4em] text-[10px] max-w-xs leading-relaxed">Redefiniendo el estándar digital para marcas de vanguardia.</p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-3 gap-20">
          <div className="flex flex-col gap-6">
            <span className="text-text-primary font-black uppercase text-[11px] tracking-widest">Soluciones</span>
            <a href="#servicios" className="text-text-primary/50 hover:text-text-primary font-bold uppercase text-[10px] tracking-widest transition-colors">Redes & Contenido</a>
            <a href="#servicios" className="text-text-primary/50 hover:text-text-primary font-bold uppercase text-[10px] tracking-widest transition-colors">Desarrollo Web</a>
          </div>
          <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-6">
               <a href="#" className="text-text-primary/50 hover:text-accent-dark font-black uppercase text-[10px] transition-colors italic tracking-widest">IG</a>
               <a href="#" className="text-text-primary/50 hover:text-accent-dark font-black uppercase text-[10px] transition-colors italic tracking-widest">LN</a>
            </div>
          </div>
        </div>
      </div>
